<?php
$path = '../../';
$page_title = 'Research Laboratories';
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Research Laboratories</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Controlled Research Environments</span>
                                    </div>
                                </div>
                            ...
                            <div class="wt-post-text">
                                <p>Cleanroom solutions for research and testing laboratories requiring precise environmental control and contamination prevention.</p>
                                
                                <h4>Our Solutions Include:</h4>
                                <ul class="list-checked">
                                    <li>Biosafety level compliant</li>
                                    <li>Precise environmental control</li>
                                    <li>Flexible modular design</li>
                                    <li>Easy reconfiguration</li>
                                    <li>Various classification levels</li>
