<?php
$path = '../../';
$page_title = 'Medical & Surgical Devices';
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Medical & Surgical Devices</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Sterile Manufacturing</span>
                                    </div>
                                </div>
                                <h2>Medical & Surgical Devices</h2>
                            </div>
                            <!-- TITLE END -->
                            
                            <div class="wt-post-text">
                                <p>ISO-compliant cleanroom solutions for the manufacturing and packaging of medical devices and surgical instruments.</p>
                                
                                <h4>Our Solutions Include:</h4>
                                <ul class="list-checked">
                                    <li>ISO 13485 compliant</li>
                                    <li>Sterile manufacturing zones</li>
                                    <li>Quality control areas</li>
                                    <li>Assembly and packaging rooms</li>
