<?php
$path = '../../';
$page_title = 'Pharmaceutical & Nutraceutical';
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Pharmaceutical & Nutraceutical</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">GMP Compliant Solutions</span>
                                    </div>
                                </div>
                            ...
                            <div class="wt-post-text">
                                <p>We provide cleanroom solutions specifically designed for the pharmaceutical and nutraceutical industries, meeting cGMP, FDA, and international standards.</p>
                                ...
                                <ul class="list-checked">
                                    ...
                                    <li>Particle control solutions</li>
