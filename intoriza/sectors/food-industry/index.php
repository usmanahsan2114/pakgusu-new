                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Food Industry</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Food Safety Solutions</span>
                                    </div>
                                </div>
                                <h2>Food Industry</h2>
                            </div>
                            ...
                            <div class="wt-post-text">
                                <p>Cleanroom solutions for food processing and packaging facilities that meet HACCP, FDA, and international food safety standards.</p>
                                
                                <h4>Our Solutions Include:</h4>
                                <ul class="list-checked">
                                    <li>HACCP compliant design</li>
                                    <li>Hygienic construction materials</li>
