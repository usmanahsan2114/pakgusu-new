<?php
$path = '../../';
$page_title = 'Hospital & Healthcare';
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Hospital & Healthcare</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Sterile Medical Environments</span>
                                    </div>
                                </div>
                                <h2>Hospital & Healthcare</h2>
                            </div>
                            <!-- TITLE END -->
                            
                            <div class="wt-post-text">
                                <p>Our cleanroom solutions for hospitals ensure the highest standards of hygiene and contamination control for operating rooms, ICUs, and sterile processing areas.</p>
                                
                                <h4>Our Solutions Include:</h4>
                                <ul class="list-checked">
                                    <li>Operating room solutions</li>
                                    <li>ICU and isolation rooms</li>
                                    <li>Sterile processing departments</li>
                                    <li>Dialysis centers</li>
                                    <li>Hospital pharmacies</li>
                                    <li>Infection control design</li>
                                </ul>
