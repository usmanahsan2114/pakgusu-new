<?php
$path = '../../';
$page_title = 'Installation Services';
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Installation Services</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Expert Installation</span>
                                    </div>
                                </div>
                            ...
                            <div class="wt-post-text">
                                <p>Our professional installation team ensures that every component is installed perfectly according to specifications and industry standards.</p>
                                
                                <h4>What We Offer:</h4>
                                <ul class="list-checked">
                                    <li>Experienced installation team</li>
                                    <li>Precision installation techniques</li>
                                    <li>Minimal disruption to operations</li>
                                    <li>Complete tool and equipment</li>
