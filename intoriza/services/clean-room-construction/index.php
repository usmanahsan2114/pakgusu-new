<?php
$path = '../../';
$page_title = 'Clean Room Construction';
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Clean Room Construction</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Professional Installation</span>
                                    </div>
                                </div>
                                <h2>Clean Room Construction</h2>
                            </div>
                            <!-- TITLE END -->
                            
                            <div class="wt-post-text">
                                <p>We provide complete turnkey cleanroom construction services, from initial planning to final commissioning. Our skilled technicians ensure quality installation following international standards.</p>
                                
                                <h4>What We Offer:</h4>
                                <ul class="list-checked">
                                    <li>Turnkey project management</li>
                                    <li>Quality material procurement</li>
