                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Planning & Design</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Expert Consultation</span>
                                    </div>
                                </div>
                            ...
                            <div class="wt-post-text">
                                <p>Our experienced team provides comprehensive planning and design services for cleanroom facilities. We work closely with clients to create optimal solutions tailored to their specific requirements.</p>
                                
                                <h4>What We Offer:</h4>
                                <ul class="list-checked">
                                    <li>Initial consultation and site survey</li>
                                    <li>Detailed 3D design and layout</li>
                                    <li>Classification and compliance planning</li>
