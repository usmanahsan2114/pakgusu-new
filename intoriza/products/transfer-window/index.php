                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Transfer Windows</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Efficient Material Transfer</span>
                                    </div>
                                </div>
                            ...
                            <div class="wt-post-text">
                                <p>Our transfer windows (pass boxes) facilitate the safe and contamination-free transfer of materials between cleanroom zones, maintaining pressure differentials.</p>
                                
                                <h4>Key Features:</h4>
                                <ul class="list-checked">
                                    <li>Interlocking door system</li>
                                    <li>UV sterilization option</li>
                                    <li>HEPA filtration available</li>
                                    <li>Stainless steel construction</li>
                                    <li>Multiple size options</li>
                                    <li>Electronic interlocking controls</li>
                                </ul>
