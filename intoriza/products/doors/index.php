                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="text-white">Cleanroom Doors</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <div class="section-head">
                                <div class="wt-separator-outer separator-left">
                                    <div class="wt-separator">
                                        <span class="site-text-primary text-uppercase sep-line-one">Secure Access Solutions</span>
                                    </div>
                                </div>
                            ...
                            <div class="wt-post-text">
                                <p>High-performance cleanroom doors engineered for optimal sealing and contamination control. Available in manual, automatic, and hermetic sealing options.</p>
                                
                                <h4>Key Features:</h4>
                                <ul class="list-checked">
                                    <li>Hermetic sealing technology</li>
                                    <li>Smooth, easy-to-clean surfaces</li>
                                    <li>Manual, sliding, or automatic operation</li>
                                    <li>Interlocking options available</li>
                                    <li>Fire-rated variants</li>
                                    <li>Vision panels available</li>
                                </ul>
