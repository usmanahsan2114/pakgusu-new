...
1.  **Relative Paths**: The template uses relative paths for assets. When moving files into subdirectories (e.g., `about/index.html`), all links to `css/`, `js/`, and `images/` must be updated to step up one level (e.g., `../css/style.css`).
