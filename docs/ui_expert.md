only for this section @index.html#L469-626 only
do this:
...
there is a dark mode in the website as well so make sure for dark mode all the colors of this section are also perfect.
Make sure all the links in this section buttons etc are also working correctly with no errors
Make sure the section is super responsive to all screens sizes, specially mobile screens
Website only has a frontend part ignore the backend commnads if any in the prompt.
make sure to not disturb any existing styling of the page other than this section

Dont change existing positions, colors and styling other than this section

This section is a part of website, any change in the CSS of this section should not effect anything else on this website but to a single section or anywhere else.
Dont repeat the styling too
